...
d3.json("data/NewsItemsSmallData.json", initialize);
...
function execute(viewBy, currCategory)
{
    ...
    d3.json("data/NewsItemsSmallData.json", convert); /// зачем мы это опять делаем так не очень понятно, но, наверное, лучше уже и не трогать
    function convert()
    {
